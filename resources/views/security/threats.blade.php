                    ...
                    <form id="add-threat-form">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="new-threat-ip"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="new-threat-score" min="0"
                                    max="100" required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="new-threat-description" class="form-label">Descripción</label>
                            <textarea class="form-control" id="new-threat-description" rows="3" placeholder="Describa la amenaza..."
                                required></textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
