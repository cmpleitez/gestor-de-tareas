                ...
                <div class="modal-body">
                    <form id="add-ip-form">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="new-ip-address" placeholder="192.168.1.100"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="new-ip-notes" class="form-label">Notas</label>
                            <textarea class="form-control" id="new-ip-notes" rows="3"
                                placeholder="Información adicional sobre esta IP..."></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
...
@section('js')
    ...
    `;
        ...
        function addNewIP() {
            ...
            console.log('Agregando nueva IP:', {
                ip,
                notes
            });
