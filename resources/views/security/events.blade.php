                        ...
                        <div class="collapse" id="advanced-filters">
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="filter-score-min" min="0" max="100" placeholder="0">
                                </div>

                                <div class="col-md-3 mb-3">
                                    <label for="filter-score-max" class="form-label">Score Máximo</label>
                                    <input type="number" class="form-control" id="filter-score-max" min="0" max="100" placeholder="100">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="text-muted">
                            Mostrando <span id="showing-start">0</span> a <span id="showing-end">0</span> de <span id="showing-total">0</span> eventos
                        </div>
            ...
            <div class="modal-body">
                <form id="event-action-form">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="action-notes" rows="3" placeholder="Describa la acción a tomar..." required></textarea>
                    </div>
                    <div class="mb-3">
