...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('app-assets/images/icons/favicon.ico') }}">
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('app-assets/images/icons/favicon.ico') }}">

    <!-- Apple Touch Icon (para iOS) -->
    <link rel="apple-touch-icon" href="{{ asset('app-assets/images/icons/apple-touch-icon.png') }}">
