                        ...
                        <div class="card">
                            ...
                            <div class="card-img-overlay product-overlay d-flex align-items-start justify-content-end" style="pointer-events: none;">
                                <ul class="list-unstyled">
                                    ...
                                    <li><a class="btn btn-success text-white mt-2 btn-agregar-kit" href="{{ Route('tienda.agregar', $kit->id) }}" style="pointer-events: auto;"><i class="fas fa-cart-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body ">
                            <a href="{{ Route('tienda.agregar', $kit->id) }}" class="text-decoration-none d-flex justify-content-center btn-agregar-kit">{{ $kit->kit }}</a>
            ...
            if (button && button.classList.contains('btn-ver-kit')) {
                ...
                fetch('{{ route("tienda.get-kit-productos") }}', { // Cargar productos del kit via AJAX
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            let agregarKitUrl = "{{ Route('tienda.agregar', ':id') }}";
