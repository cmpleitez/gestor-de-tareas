                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group" role="group" aria-label="label">
                                            <a href="#" role="button" data-toggle="modal" data-target="#modalEntrada"
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <select class="form-control" name="origen_stock_id" id="origen_stock_id" required
                                        ...
                                        <option value="{{ $stock->id }}" {{ old('origen_stock_id')==$stock->id ? '
                                            selected' : '' }}>
                                            {{ $stock->stock }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <select class="form-control" name="destino_stock_id" id="destino_stock_id" required
                                        form="formEntrada">
                                        @foreach ($stocks as $stock)
                                        <option value="{{ $stock->id }}" {{ old('destino_stock_id')==$stock->id ? '
                                            selected' : '' }}>
                                            {{ $stock->stock }}
                                        </option>
                                        @endforeach
...
<script>
    $(document).ready(function() {
            ...
            $('#origen_stock_id').on('change', function () {
                ...
                if (origenVal !== '0') {
                    var valorDestino = $('#destino_stock_id option').filter(function() {
            ...
            $('#destino_stock_id').on('change', function () {
                ...
                if (destinoVal !== '4') {
                    var valorOrigen = $('#origen_stock_id option').filter(function() {
