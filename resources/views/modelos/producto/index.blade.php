                        ...
                        <table id="datatable" class="table zero-configuration table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-secondary-dark text-white font-weight-bold" style="font-size: 0.8rem;">{{ $producto->codigo }}</span></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="label">
                                            ...
                                            {{-- ELIMINAR --}}
                                            @can('eliminar')
                                            <a href="#" data-url="{{ route('producto.destroy', $producto->id) }}" role="button"
                                                data-toggle="tooltip" data-popup="tooltip-custom" data-html="true"
                                                data-placement="bottom"
