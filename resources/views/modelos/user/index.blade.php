                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('user.activate', $user->id) }}" method="POST"
                                                        ...
                                                        <div class="custom-control custom-switch"
                                                            ...
                                                            data-content="<i class='bx bxs-error-circle'></i> {{ $user->activo ? 'Desactivar' : 'Activar' }} {{ $user->name }}">
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="label">
                                                        @can('autorizar')
                                                            ...
                                                            <a href="{{ route('user.solicitudes-edit', $user->id) }}"
                                                                ...
                                                                data-html="true"
                                                                data-content="<i class='bx bxs-group'></i> Actualizar habilidades de {{ $user->name }}"
                                                                class="button_show">
                                                            ...
                                                            <a href="{{ route('user.equipos-edit', $user->id) }}"
                                                                role="button" data-toggle="popover" data-placement="top"
                                                                data-html="true"
                                                                data-content="<i class='bx bxs-group'></i> Equipos de {{ $user->name }}"
                                                                class="button_show">
                                                            ...
                                                            <a href="{{ route('user.roles-edit', $user->id) }}" role="button"
                                                                ...
                                                                data-content="<i class='bx bxs-error-circle'></i> Roles de {{ $user->name }}"
                                                                class="button_keys">
                                                        ...
                                                        @can('editar')
                                                            <a href="{{ route('user.edit', $user->id) }}" role="button"
                                                                data-toggle="popover" data-placement="top" data-html="true"
                                                                data-content="<i class='bx bxs-error-circle'></i> Editar datos de {{ $user->name }}"
                                                        ...
                                                        @can('eliminar')
                                                            <a href="{{ route('user.destroy', $user->id) }}" role="button"
                                                                data-toggle="popover" data-placement="top" data-html="true"
                                                                data-content="<i class='bx bxs-eraser'></i> Eliminar {{ $user->name }}"
...
@section('js')
    ...
    <script>
        // ===== INICIALIZACIÓN ESPECÍFICA DE POPOVERS PARA USUARIOS =====
        $(document).ready(function() {
            // Función para inicializar popovers con clases contextuales
            function initializeUserPopovers() {
