                        ...
                        <div class="ml-auto d-flex align-items-center">
                            @if (auth()->user()->hasRole('Gestor') || auth()->user()->hasRole('Supervisor'))
                                <button type="button" class="btn btn-sm btn-outline-light mr-2"
                                    id="btn-distribuir-todas" data-toggle="tooltip" data-placement="top"
    ...
    <script>
        ...
        $(document).on('click', '.kanban-overlay, .kanban-sidebar .close-icon',
            function() { //Cerrar sidebar al hacer clic en overlay o en el icono de cierre
                ...
                //VERIFICAR SI SE USA
                $('.solicitud-card').removeClass('dragging sortable-drag sortable-chosen sortable-ghost'); // Limpiar clases de rotación y drag que puedan haber quedado
                $('.sortable-fallback').remove();
            }
        );
        //CERRAR SIDEBAR
