...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card">
            ...
            <!-- FORMULARIO -->
            <form class="form-horizontal" action="{{ route('tarea.update', $tarea->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Tarea</label>
                                    <div class="controls">
                                        <input type="text" name="tarea" value="{{ $tarea->tarea }}"
                                            ...
                                            placeholder="Nombre de la nueva tarea" value="{{ old('tarea', $tarea->tarea) }}" required>
                                        @error('tarea')
