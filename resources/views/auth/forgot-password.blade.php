...
<head>
    ...
    <title>Recuperar Clave - Gestor de Tareas</title>
                                        ...
                                        <div class="card-content m-0">
                                            <div class="card-body">
                                                <div class="text-muted text-center mb-3">
                                                    <small>Ingresa tu correo electrónico y te enviaremos instrucciones para restablecer tu clave.</small>
                                                </div>
                                                ...
                                                <form method="POST" action="{{ route('password.email') }}">
                                                    ...
                                                    <button type="submit" class="btn btn-primary glow w-100 position-relative mb-2">
                                                        Enviar enlace <i id="icon-arrow" class="bx bx-right-arrow-alt"></i>
                                                    </button>
                                                </form>
                                                <div class="text-center mt-1">
                                                    <a href="{{ route('login') }}" class="card-link"><small>Volver al inicio de sesión</small></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
