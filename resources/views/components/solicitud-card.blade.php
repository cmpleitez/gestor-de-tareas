...
<div class="solicitud-card" data-id="{{ $solicitud['recepcion_id'] }}" data-atencion-id="{{ $solicitud['atencion_id'] }}"
    data-estado-id="{{ $solicitud['estado_id'] }}" data-fecha="{{ $solicitud['created_at'] }}"
    ...
    <div class="users-container"
        ...
        @foreach ($solicitud['users'] as $user)
            <div style="margin: 0;" data-toggle="popover" data-title="{{ $user['name'] }}"
